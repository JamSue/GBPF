...
log_file = f'./logs/training111_{args.model}_{args.dataset}_info.log' # 日志文件名称
...
best_accuracy = 0.0
current_step = 0
ballData_path = './gb_data/{}_{}_ballData_111.npy'.format(args.dataset,args.model)
...
for epoch in range(1,1+args.epoch):
    ...
    if epoch < 5:
        ...
        for batch_index,(texts,label) in enumerate(train_iterator):
            ...
            # loss = entropyLoss + (args.a*dis_center_pos - args.b*dis_center_neg)
            ...
            if step % 100 == 0: #每100次做一次评估         
                ...
                with torch.no_grad():
                    ...
                    if vote_test_accuracy > best_accuracy:
                        ...
                        file_path = './gb_data/{}_{}_ballData_111.npy'.format(args.dataset,args.model) # 保存的npy文件路径 
